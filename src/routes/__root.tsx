...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: import.meta.env.VITE_APP_URL ?? "https://luxurioushomes.broad-tooth-82ac.workers.dev" },
      { property: "og:site_name", content: "Luxurious Homes Dubai" },
      { property: "og:image", content: `${import.meta.env.VITE_APP_URL ?? "https://luxurioushomes.broad-tooth-82ac.workers.dev"}/og-image.jpg` },
      ...
      { name: "twitter:image", content: `${import.meta.env.VITE_APP_URL ?? "https://luxurioushomes.broad-tooth-82ac.workers.dev"}/og-image.jpg` },
